...
//        });
    ...
    private TreeItem createTreeItem(Object entity, String name){
        ...
        String value = entity.toString();
        if(!entity.getClass().isEnum() && entity.getClass() != String.class && entity.getClass().getSuperclass() != Number.class && entity.getClass() != Boolean.class) {
            if(entity instanceof Iterable){
                ...
                item = new TreeItem<>(name + ": " + (value.length()>30 ? value.substring(0,30)+"..." : value) + " (" + entity.getClass().getCanonicalName() + ")");
